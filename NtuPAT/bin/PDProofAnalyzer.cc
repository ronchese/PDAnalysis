...
#include "PDAnalysis/NtuPAT/src/PDNtupleData.cc"
#include "PDAnalysis/NtuPAT/src/PDEventSelect.cc"
#include "PDAnalysis/NtuPAT/src/PDUtil.cc"
#include "PDAnalysis/NtuPAT/src/PDNtuple.cc"
...
#include "PDAnalysis/NtuPAT/bin/PDAnalyzer.cc"
#include "TFile.h"
#include "TChain.h"
#include <fstream>
...
void PDProofAnalyzer::SlaveBegin(TTree * /*tree*/) {
  ...
  while ( o_iter != o_iend ) {
    ...
    type = obj->ClassName();
    cout << "type:" << type << endl;
    if ( type.substr( 0, 2 ) == "TH" ) fOutput->Add( obj );
  }
  return;
