#include "PDAnalysis/EDM/interface/PDPATToNtuple.h"
...
//      ElectronEffectiveArea::kEleEAData2011 );
    eleID     ->at( iObj ) = 0;//electron.electronID( "xxx" );
/*
    std::cout << iObj << " eidLoose "
  << electron.electronID( "eidLoose" ) << std::endl;
    std::cout << iObj << " eidRobustHighEnergy "
  << electron.electronID( "eidRobustHighEnergy" ) << std::endl;
    std::cout << iObj << " eidRobustLoose "
  << electron.electronID( "eidRobustLoose" ) << std::endl;
    std::cout << iObj << " eidRobustTight "
  << electron.electronID( "eidRobustTight" ) << std::endl;
    std::cout << iObj << " eidTight "
  << electron.electronID( "eidTight" ) << std::endl;
    std::cout << iObj << " mvaNonTrigV0 "
  << electron.electronID( "mvaNonTrigV0" ) << std::endl;
    std::cout << iObj << " mvaTrigV0 "
  << electron.electronID( "mvaTrigV0" ) << std::endl;
    std::cout << iObj << " simpleEleId60cIso "
  << electron.electronID( "simpleEleId60cIso" ) << std::endl;
    std::cout << iObj << " simpleEleId60relIso "
  << electron.electronID( "simpleEleId60relIso" ) << std::endl;
    std::cout << iObj << " simpleEleId70cIso "
  << electron.electronID( "simpleEleId70cIso" ) << std::endl;
    std::cout << iObj << " simpleEleId70relIso "
  << electron.electronID( "simpleEleId70relIso" ) << std::endl;
    std::cout << iObj << " simpleEleId80cIso "
  << electron.electronID( "simpleEleId80cIso" ) << std::endl;
    std::cout << iObj << " simpleEleId80relIso "
  << electron.electronID( "simpleEleId80relIso" ) << std::endl;
    std::cout << iObj << " simpleEleId85cIso "
  << electron.electronID( "simpleEleId85cIso" ) << std::endl;
    std::cout << iObj << " simpleEleId85relIso "
  << electron.electronID( "simpleEleId85relIso" ) << std::endl;
    std::cout << iObj << " simpleEleId90cIso "
  << electron.electronID( "simpleEleId90cIso" ) << std::endl;
    std::cout << iObj << " simpleEleId90relIso " 
 << electron.electronID( "simpleEleId90relIso" ) << std::endl;
    std::cout << iObj << " simpleEleId95cIso "
  << electron.electronID( "simpleEleId95cIso" ) << std::endl;
    std::cout << iObj << " simpleEleId95relIso "
  << electron.electronID( "simpleEleId95relIso" ) << std::endl;
    std::cout << iObj << " pf_evspi "
  << electron.electronID( "pf_evspi" ) << std::endl;
    std::cout << iObj << " pf_evsmu "
  << electron.electronID( "pf_evsmu" ) << std::endl;
*/
